...
const EKUBO_ACCESS_CONTROL_CONTRACTS: ContractConfig[] = [
  {
    address: standariseAddress("0x0636a3f51cc37f5729e4da4b1de6a8549a28f3c0d5bf3b17f150971e451ff9c2"),
    asset: "", // Not applicable for access control contracts
    name: "Ekubo Access Control 1",
  },
  {
    address: standariseAddress("0x00707bf89863473548fb2844c9f3f96d83fe2394453259035a5791e4b1490642"),
    asset: "",
...
const KNOWN_ROLE_NAMES: Record<string, string> = {
  ...
  // selector!("GOVERNOR")
  "0x26838efa4183e08fe3607359d1259272af9d4716f65e1a7b5921f78fd5a3c6a": "GOVERNOR",
  // selector!("RELAYER")
  "0x34f864e5201b0fde9b5ee3e4cf96384802b0ffdfcf7f9de4699ce21a30afc4f": "RELAYER",
  // selector!("EMERGENCY_ACTOR")
  "0x34cde74b9063efe5d744d0e7c535eca81c0e48ad60da32f9963463ceb475c4b": "EMERGENCY_ACTOR",
};
...
function decodeRoleName(roleHex: string): string {
  ...
  return KNOWN_ROLE_NAMES[normalised] ?? `UNKNOWN_ROLE_${normalised.substring(0, 10)}`;
}
...
export const CONFIG_ACTIVE_PERMISSIONS: EventConfig[] = [
  // RoleGranted Event
  {
    ...
    defaultKeys: [[eventKey("RoleGranted")]],
    keyFields: [],
    dataFields: [
  ...
  // RoleRevoked Event
  {
    tableName: "role_events",
    contracts: ALL_ACCESS_CONTROL_CONTRACTS,
    defaultKeys: [[eventKey("RoleRevoked")]],
    keyFields: [],
    dataFields: [
      { name: "role", type: "text", sqlType: "text" },
      { name: "account", type: "ContractAddress", sqlType: "text" },
  ...
  // RoleAdminChanged Event
  {
    tableName: "role_events",
    contracts: ALL_ACCESS_CONTROL_CONTRACTS,
    defaultKeys: [[eventKey("RoleAdminChanged")]],
    keyFields: [],
    dataFields: [
      { name: "role", type: "text", sqlType: "text" },
